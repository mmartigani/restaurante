...
#y el 0+0 nos indica el ejesuperior derecho
aplicacion.geometry('1230x1020+0+0')#1020x630#1230x1020

#evitar que se maximize
aplicacion.resizable(0,0)

#titulo de la ventana 
aplicacion.title('Sistema De Facturacion')
#color de fondo de la ventana 
aplicacion.config(bg='dark olive green')
...
etiqueta_titulo=Label(panel_superior, text='Sistema de Facturacion', fg='azure4',
                      font=('Dosis', 60), bg='dark olive green',width=27)
...
#PANEL CALCULADORA 
panel_calculadora=Frame(panel_derecha, bd=1, relief=FLAT,bg='dark olive green')
panel_calculadora.pack() #por defecto sin no ponemos nada va ir en la parte de arriba 

#PANEL RECIBO 
panel_recibo=Frame(panel_derecha, bd=1, relief=FLAT,bg='dark olive green')
panel_recibo.pack()
#PANEL BOTONES 
panel_botones=Frame(panel_derecha, bd=1, relief=FLAT,bg='dark olive green')
panel_botones.pack()

#lista de productos 

lista_comidas=['pollo', 'cordero', 'carne', 'salmon', 'pizza','pastas', 'sandwich', 'cazuelas']
lista_bebidas=['agua', 'soda', 'gaseosa','leche', 'cerveza','cafe', 'te','capuchino' ]
lista_postres=['tortas', 'helado', 'tartas', 'flan', 'mouse','masas', 'alfajores','pasta frola']
...
#etiquetad de costo y campos de entrada 
...
visor_calculadora.grid(row=0,
                       column=0,
                       columnspan=4)
botones_calculadora=['7', '8','9','+','4','5','6','-','1','2',
                     '3','x','R','B','0','/']
botones_guardados=[]
